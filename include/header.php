<header id="header" class="transparent-header-modern fixed-header-bg-white w-100">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <ul class="top-contact list-text-white  d-table">
                                <li><a href="#"><i class="fas fa-phone-alt text-success mr-1"></i> 010-7775031</a></li>
                                <li><a href="#"><i class="fas fa-envelope text-success mr-1"></i>ongtiang1999@gmail.com</a></li>
                            </ul>
                        </div>
                        <div class="col-md-4">
            ...
            <div class="main-nav secondary-nav hover-success-nav py-2">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <nav class="navbar navbar-expand-lg navbar-light p-0"> <a class="navbar-brand position-relative" href="index.php"><img class="nav-logo" src="images/logo/icon.png" alt=""></a>
                                    ...
                                    <ul class="navbar-nav mr-auto">
										...
										<li class="nav-item dropdown">
											...
											<ul class="dropdown-menu">
                                                ...
                                                <?php
                                if (isset($_SESSION['utype']) && $_SESSION['utype'] === 'agent') {
        ...
        <script>
    // Set the timeout duration in milliseconds (5 minutes)
    ...
    function logout() {
        // Redirect to the logout page or perform any logout logic
