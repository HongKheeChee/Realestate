...
if (isset($_POST['addabout'])) {
    ...
    // Validation
    if (empty($title)) {
        $error = "<p class='alert alert-warning'>* Title is required</p>";
    } elseif (empty($content)) {
        $error = "<p class='alert alert-warning'>* Content is required</p>";
    } elseif (empty($aimage)) {
        $error = "<p class='alert alert-warning'>* Image is required</p>";
    } else {
        // Check if the file is an image
        $allowed_extensions = array("jpg", "jpeg", "png", "gif");
        $file_extension = strtolower(pathinfo($aimage, PATHINFO_EXTENSION));
        if (!in_array($file_extension, $allowed_extensions)) {
            $error = "<p class='alert alert-warning'>* Invalid image format. Allowed formats: jpg, jpeg, png, gif</p>";
        } else {
            // Move uploaded file if validation passes
