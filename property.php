...
<script>
    function validateForm() {
        var amount = document.forms["instalmentForm"]["amount"].value;
        var month = document.forms["instalmentForm"]["month"].value;
        var interest = document.forms["instalmentForm"]["interest"].value;

        if (amount == "" || isNaN(amount)) {
            alert("Please enter a valid property amount");
            return false;
        }
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4">
						...
						<form class="d-inline-block w-100" action="calc.php" method="post" name="instalmentForm" onsubmit="return validateForm()">
